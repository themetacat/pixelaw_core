...
import {CellDatum, Coordinate} from '../components/shared/DrawPanel'
...
import {CANVAS_HEIGHT, CANVAS_WIDTH, MAX_CELL_SIZE, MAX_ROWS_COLS} from '../global/constants'
// import {useEntityQuery} from '@dojoengine/react'
// eslint-disable-next-line @typescript-eslint/ban-ts-comment
// @ts-ignore
import {getComponentValue, Has} from '@latticexyz/recs'
import { argbToHex } from '../global/utils'
...
//   const entityIds = useEntityQuery([ Has(Pixel) ])
  const entityIds = [ Has(Pixel) ] as any;
...
function useDojo(): { setup: { components: { Pixel: any } } } {
