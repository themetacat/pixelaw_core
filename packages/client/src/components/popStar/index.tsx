...
export default function PopStar({setPopStar}:Props) {
  return (
    <div className={style.content}>
      ...
      <div className={style.Container}>
        ...
        <span className={style.copywritingTwo}>
          {" "}
          rewarded for completions.<br/>In order to complete the game, made,you may
          need materials made from the game
        </span>
